...
io.on("connection", function (socket_) {
  ...
  socket.on("join", function (data) {
    ...
    let randomX = 0; // bimmer: fixed spawn south of the UNBC building (0.5 m model)
    let randomZ = -800;

    let groundHeight = 7 * world.blockSize; // bimmer: flat world grass is at y=4, spawn just above it
